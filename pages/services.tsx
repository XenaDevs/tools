...
const OtherServices = () => {
  return (
    <main className="px-10 md:px-20 lg:px-30 max-w-7xl mx-auto">
      <h2 className="pt-16 mb-2 md:mt-10 text-lg text-Accent">
        Did you know that we offer more services than our tools?
      </h2>
      <p>We offer custom websites, hosting, and discord bots.</p>
        ...
        <div className="flex flex-col gap-12 items-center">
          <div className="my-4">
            <p className="mb-6">
              ...
              <span className="text-Accent">18.000</span> individual servers and
      ...
      <section className="min-h-full pt-4 md:mt-10">
        <div className="flex flex-col gap-12 items-center">
